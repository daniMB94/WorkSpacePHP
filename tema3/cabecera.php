                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                            data-bs-target="#collapseLayoutsProyectos" aria-expanded="false"
                            aria-controls="collapseLayoutsProyectos">
                            <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                            Proyectos
                            <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                        </a>
                        <div class="collapse" id="collapseLayoutsProyectos" aria-labelledby="headingOne"
                            data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                                    data-bs-target="#collapseLayoutsAnadirProyecto" aria-expanded="false"
                                    aria-controls="collapseLayoutsAnadirProyecto">
                                    <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                    Añadir Proyecto
                                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                                </a>
                                <div class="collapse" id="collapseLayoutsAnadirProyecto"
                                    data-bs-parent="#collapseLayoutsProyectos">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <form action="">
                                            <input type="text">
                                            <input type="date">
